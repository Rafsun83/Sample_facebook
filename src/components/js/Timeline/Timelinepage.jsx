                                ...
                                <div className="Timelinepage-personal-intro">
                                    ...
                                    <div className="Info-personal">
                                        <div className="Timeline-intro text-muted">
                                            <span className="iconify info-icon" 
                                            data-icon="mdi:store-clock"></span>
                                            <p>Studying of Student</p>
                                        </div>
                                        <div className="Timeline-intro text-muted">
                                            <span className="iconify info-icon" 
                                            data-icon="mdi:school"></span>
                                            <p>Studied at <Link>
                                            <strong>Bangladesh University of Business and technology-(BUBT)</strong>
                                            </Link> </p>
                                        </div>
                                        <div className="Timeline-intro text-muted">
                                            <span className="iconify info-icon" 
                                        ...
                                        <div className="Timeline-intro text-muted">
                                            <span className="iconify info-icon" 
                                            data-icon="mdi:heart-pulse"></span>
                                            <p>Single</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="Timelinepage-photos">
                            <div className="Timelinepage-first">
                                ...
                                <div className="Timeline-album">
                                    <Link><img src={profileImg} alt="" /></Link>
                                    <Link><img src={profileImg} alt="" /></Link>
                                    <Link><img src={profileImg} alt="" /></Link>
                                    <Link><img src={profileImg} alt="" /></Link>
                                    <Link><img src={profileImg} alt="" /></Link>
                        ...
                        <div className="Timelinepages-bar">
                           ...
                           {/* timeline edit button start */}
                            <div className="edit-div">
                                ...
                                <span className="iconify Edit-icon" 
                                data-icon="mdi:account-edit">
                                </span> Edit Profile</button>
                                <Link>
                                <span className="iconify dot-icon" 
                            ...
                            <div className="Timeline-post">                        
                                <div className="create-Timeline-post">
                                    ...
                                    <form action="/form/submit" method="POST">
                                        <textarea class="comment text-muted" 
                                        placeholder="What's on your feelings? "></textarea>
                                        <br/>
                                    </form>
                                ...
                                <div className="TimelinePost-button">
                                    <div className="Postupdate-button">
                                     <button className="post-btn">  
                                        <span className="iconify post-icon" 
                                        data-icon="mdi:note-check">
                                        </span> Post</button>
                                    </div>
                                    <div className="Postupdate-button">
                                      <button  className="post-btn"> 
                                        <span className="iconify photos-icon" 
                                    ...
                                    <div className="Postupdate-button">
                                        <button  className="post-btn"> 
                                        <span className="iconify video-icon" 
                                        ...
                                        <div className="pages-post-head">
                                            ...
                                            <div className="pages-post-title">
                                                ...
                                                <p className="Post-Name"> 
                                                    <strong className="user-Name">Wasek samin</strong> posted an update</p>
                                                </Link>
                                          ...
                                          {/* post like comment button start  */}
                                            <div className="express-button">
                                                <button className="express-button1">
                                                    ...
                                                    data-icon="mdi:comment-outline"></span>COMMENT</button>
                                                <button className="express-button2">
                                                    <span className="iconify heart-icon" 
                                                    data-icon="mdi:heart-outline"></span>LIKE</button>
                                                <button className="express-button3">
                                                    <span className="iconify heart-icon" 
                                                    data-icon="mdi:share-variant-outline"></span>SHARE</button>
                                            </div>
                                    ...
                                    <div className="update-propic">
                                        <div>
                                            ...
                                            <div className="comment-section">
                                                ...
                                                <input className="comment-input" 
                                                placeholder="Write a public comment.." type="text"/>
                                                <span className="iconify comment-icon" 
                                                data-icon="mdi:emoticon-outline"></span>
                                            </div>
